...
export const resume = {
  basic: {
    ...
    summary:
      '嵌入式软件工程师，擅长嵌入式系统软件开发与控制电路设计分析。熟悉 ARM Cortex-M、RISC-V 等 MCU 编程，具备医疗器械与轨道交通等行业项目经验。',
  },
  skills: [
    'C / C++',
  ...
  works: [
    {
      ...
      title: '嵌入式软件工程师',
      duties: [
        '负责医疗器械产品的市场调研、软件开发与项目管理',
        '负责或协助多款医疗器械的市场调研及产品功能设计',
        '负责多款器械的软件组件的设计、开发与调试，编制软件开发文档',
        '协助产品经理进行医疗器械的检验、注册与考核',
    ...
    },
    {
      ...
      title: '组长',
      duties: [
        '担任软件一组组长，负责项目分配、新产品/功能研发及新员工培养',
        '负责旧产品软件重构，将低内聚高耦合架构改写为高内聚低耦合架构',
        '协助硬件工程师进行项目选型、原理图审核',
        '在新硬件架构及新软件 SDK 方案上实现既有产品功能，降本增效，并负责新功能开发',
      ],
      achievements: [
        '成功完成多种软件项目，为产品开发十余种新功能，获得同事与客户广泛好评',
        '培养多名新员工及实习员工，充实研发能力，在市场环境恶化情况下保持公司主要营收来源',
        '成功拆分旧软件框架，重构模式功能与 GUI 两个任务，降低新产品开发难度',
        '协助产品方案审定、功能框图编制、原理图审核等工作',
        '在新硬件平台应用新软件架构，成功实现产品功能；新平台使显示待机功耗下降约 80%，扩大市场',
      ],
    },
    {
      ...
      title: '电气工程师',
      duties: [
        '设计动车组列车照明控制系统软件：根据列车控制系统经 TRDP 协议下发的控制信息及列车外部环境亮度，调节照明灯具亮度与色温',
        '设计动车组列车照明灯具中光源板电路及 PCB',
        '设计动车组列车照明系统的电气接线及接口定义',
      ],
      achievements: [
        '所设计的控制器软件和光源板已应用于贵阳城际动车组列车及四川新筑磁悬浮列车',
      ],
    },
  ] as WorkItem[],
  projects: [
    ...
    },
    {
      ...
      role: '负责全部软件开发与软件文档，配合硬件选型与电路设计',
      highlights: ['nRF52 + FreeRTOS', '四层架构', '全蓝牙控制'],
    },
    {
      name: '多用途家庭音频中心',
      description:
        '基于 RISC-V 架构蓝牙音频芯片与 FreeRTOS。功能包括：SPI 控制数字广播芯片实现数字广播及文本播放；I²C 控制调频广播芯片并解码用于时间同步或广播文本；通过 AVRCP、A2DP 等蓝牙规范连接设备播放与控制音频；USB/SD 播放本地音频；UART 与从模块通信；高精度 ADC 接收 FM、音频接口、CD Servo、磁带从机等音频并播放。',
